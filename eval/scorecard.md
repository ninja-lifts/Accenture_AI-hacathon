...
### Retired
Left in place per PROJECT_RULES.md's rule for an ill-posed scenario - ground_truth unchanged, notes explain why, full analysis in data/manifest_reconciliation.md.
